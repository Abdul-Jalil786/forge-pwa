const CACHE='forge-v132';
const ASSETS=['/','/index.html','/manifest.json','/targets.js','/programme-shared.js','/proactive-core.js','/kb-emom.js','/data.js','/workout.js','/pages.js','/app.js','/login.html','/login.js'];
