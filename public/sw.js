const CACHE='forge-v152';
const ASSETS=['/','/index.html','/manifest.json','/targets.js','/starter-plan.js','/programme-shared.js','/proactive-core.js','/kb-emom.js','/kb-density.js','/data.js','/workout.js','/pages.js','/app.js','/login.html','/login.js'];
