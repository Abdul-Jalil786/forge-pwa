...
const WORKOUTS = {
  ...
  lowerA: {
    ...
    exercises:[
      ...
      {id:'l1',name:'Leg Press',sets:3,reps:'8–10',rest:120,muscle:'Quads',size:'large',fillers:['fill_band_ext_rot'],yt:'https://www.youtube.com/results?search_query=leg+press+form+technique'},
...
const STRETCH_ROUTINES = {
  morning: {
    ...
    stretches: [
      ...
      { id:'s9_hip_switch', name:'90/90 Hip Switch', duration:10, unit:'reps', sides:false,
        instructions:"Sit with both knees bent to 90° — one shin in front, one out to the side. Rotate the knees side to side, keeping the feet planted, letting the hips open and close.",
        benefit:"Hip internal and external rotation. Restores the rotation the hips lose from sitting.",
        cue:"Chest tall — move from the hips, not the lower back" },
      { id:'s10_deep_squat_hold', name:'Deep Squat Hold', duration:90, unit:'seconds', sides:false,
        instructions:"Drop into a bodyweight squat to full depth with the heels flat and the elbows inside the knees. Hold at the bottom — three thirty-second efforts, standing to rest between if you need to.",
        benefit:"Ankle, knee and hip range at depth. Opens the bottom position of every squat pattern.",
  ...
  evening: {
    ...
    stretches: [
      ...
      { id:'e8_couch_stretch', name:'Couch Stretch', duration:75, unit:'seconds', sides:true,
        instructions:"Elevate the rear foot behind you against a wall or couch, back knee down on the floor. Tuck the pelvis under and drive the hips forward until you feel the stretch in the back-leg hip flexor.",
        benefit:"Hip flexor length. Releases the front of the hip after a day of sitting and training.",
        cue:"Squeeze the glute of the back leg — don't arch the lower back" },
      { id:'e9_butterfly', name:'Butterfly Stretch', duration:90, unit:'seconds', sides:false,
        instructions:"Sit with the soles of the feet together, knees dropping toward the floor. Lean gently forward from the hips over the feet.",
        benefit:"Groin and hip external rotation. Opens the inner thighs and settles the hips before sleep.",
        cue:"Fold from the hips — keep the spine long" },
    ],
  },
  ...
  flexibility: {
    ...
    stretches: [
      ...
      { id:'f10_pigeon', name:'Pigeon Stretch', duration:90, unit:'seconds', sides:true,
        instructions:"Bring the front shin across the body, rear leg extended straight back behind you. Fold over the front leg, lowering the torso toward the floor as far as is comfortable.",
        benefit:"Deep glute and hip rotation. The strongest opener for the outer hip and glute.",
