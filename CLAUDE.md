...
- 21: Fix Oura sleep sync — relax type filter so late_nap/rest with 5+ hours counts as main sleep (fixes daytime-shifted 3am-1pm patterns), stop auto-deleting sleepLog entries when Oura returns no data for a day
